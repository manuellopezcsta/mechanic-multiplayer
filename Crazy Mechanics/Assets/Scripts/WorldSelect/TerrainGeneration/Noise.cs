...
public static class Noise
{
    ...
    public static float[,] GenerateNoiseMap(int mapWidth, int mapHeight, int seed, float scale, int octaves, float persistance, float lacunarity, Vector2 offset)
    {
        ...
        //seed: Semilla para generaci�n reproducible.
        //scale: Factor de zoom / ampliaci�n del ruido.
        //octaves: N�mero de capas de ruido a combinar.
        //persistance: Controla la disminuci�n de amplitud en cada octava.
        //lacunarity: Controla el aumento de frecuencia en cada octava.
        //offset: Permite desplazar el mapa generado.

        //generador de n�meros aleatorios con la semilla dada.
        ...
        float maxNoiseHeight = float.MinValue; //Variable para que el numero mas alto sea el mas peque�o que tiene unity.
        ...
        for (int y = 0; y < mapWidth; y++)
        {
            for (int x = 0; x < mapHeight; x++)
            {
                ...
                //Actualiza los valores m�ximos/minimos encontrados
